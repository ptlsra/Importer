		  ...
		  $.each(responseDataEvent.records, function(i, item) {
			...
			//  alert(lengthofrec);
			 ...
			 // alert(prevRecordEventName)
			  ...
			  if(eventName=='DocumentUploadByImporter' && prevRecordEventName=='UpdateAssetArrival'){
				  document.getElementById('uploadDoc').innerHTML=  ' <img src="assets/img/tick3.png" width="12px" height="12px" style="margin-bottom:1px;"><a class="blck" href="#" onclick=check("Documents_Uploaded_By_Shipper")>Upload Document</a><p><img src="assets/img/tick3.png" width="12px" height="12px"><a class="blck" href="#" onclick=check("ConfirmShippingByShipper")>Ship to Exporter Port</a>';
					...
					document.getElementById('importerTab').innerHTML= ' <img src="assets/img/tick3.png" width="12px" height="12px" style="margin-bottom:1px;"><a class="blck" href="#" onclick=check2("UpdateAsset3")>Confirm Arrival</a><p><img src="assets/img/tick3.png" width="12px" height="12px"><a class="blck" href="#" onclick=check("DocumentUploadByImporter")>Upload Documents -> Asset Delivered</a>';
		...
		//    $("#frame").attr("src", "http://"+ipfsIpAdd+":"+ipfsPort+"/ipfs/"+responseDataValue.insuranceHash);
		   ...
		   // $("#frame3").attr("src", "http://"+ipfsIpAdd+":"+ipfsPort+"/ipfs/"+responseDataValue.customDocsHash);
		     ...
		     $('#btnShow4').click(function(){
		            ...
		            $.get("/ipfs?fileHash=" + responseDataValue.goodsReceivedHash, function (response) {
						$("#frame4").attr("src", response.ipfsUrl);
					});
		 //   $("#frame4").attr("src", "http://"+ipfsIpAdd+":"+ipfsPort+"/ipfs/"+responseDataValue.goodsReceivedHash);
